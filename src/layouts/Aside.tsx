        ...
        >
          <div className="space-y-6 md:space-y-10 mt-10">
            ...
            <div id="menu" className="flex flex-col space-y-2">
              ...
              <Link
                to="categories"
                className=" font-medium text-gray-700 py-2 px-2 hover:bg-teal-500 hover:text-white hover:scale-105 rounded-md transition duration-150 ease-in-out cursor-pointer"
              >
              ...
              >
                ...
                <span className=" z-10">Reports</span>
              </a>
